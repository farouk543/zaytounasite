...
@php
  ...
  $levelsArr = ($levels ?? collect())->map(function($l){
    ...
    $group = 'primary';
    if (str_starts_with($slug, 'middle')) $group = 'middle';
...
{!! json_encode([
  ...
  'groupLabels'    => $groupLabels,
  'startUrl'       => route('regimes.qatar.start'),
      ...
      <div class="za-tracksGrid" style="margin-top:18px;">
        @foreach($packs as $i => $p)
          @php
            ...
            // Compute visitor currency conversion for display
            $convDisplay = '';
...
function regimeSelector(cfg){
  return {
    ...
    currencySymbol: cfg.currencySymbol || 'QAR',
