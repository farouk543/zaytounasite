...
@php
  ...
  $backUrl = $backRoute ?? route('regimes.quran.show');
@endphp
        ...
        @if(!$isCustom)
          <div style="display:flex; justify-content:space-between; gap:14px; flex-wrap:wrap; align-items:flex-end;">
            ...
            <div style="display:flex; gap:10px; flex-wrap:wrap;">
              ...
              <form method="POST" action="{{ route('regimes.quran.submit') }}" style="display:inline;">
                @csrf
              ...
              <tbody>
                @foreach($items as $it)
                  ...
                  <tr style="border-top:1px solid rgba(15,23,42,.08);">
                    ...
                    <td style="padding:12px; font-weight:900;">{{ number_format((float)$lineMonthly, 0) }} {{ $symbol }}</td>
                  </tr>
                @endforeach
              </tbody>
            </table>
